...
小鲸鱼娘住在 Marcel SSH 右下角，帮你盯着 DeepSeek 账户余额。支持拖拽吸附、镜像翻转、Q 弹挤压、梁文峰/文谷高峰空闲显示（文案可自定义、可开关），随界面自动启用。
...
- 💹 **梁文峰 / 梁文谷**：按北京时间高峰 9-12/14-18 与空闲双档计价，`hint` 高峰/空闲文案可自定义（默认“文峰当班”/“文谷摸鱼”），悬浮可见完整价目（输入命中/未命中/输出 空闲/高峰两档）
...
- **梁文峰/文谷**：设置页开关 + 高峰/空闲文案自定义（各 20 字内），关闭则回落为“点击刷新”
